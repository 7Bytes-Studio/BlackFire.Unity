...
namespace BlackFire.Unity.Editor.Runtime
{
	...
	public class InspectorAttribute : Attribute
    {
        ...
        /// <summary>
        /// The label used to identify the field in the inspector. Is usually displayed on the left side of 
        /// the value for int, float, string field. For button, this the text display in the center of the button.
        /// If empty, the unity default naming will be used.
        /// </summary>
        public string label = "";
