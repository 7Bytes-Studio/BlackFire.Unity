...
namespace BlackFire.Unity
{
	public static class BlackFireGUI 
	{
        ...
        {
            ScrollView(BlackFire.Utility.Unique.GetId(scrollIdText),drawCallback, gUILayoutOptions);
        }
        ...
        public static Rect GetWindowRect(string windowIdText) { return GetWindowRect(BlackFire.Utility.Unique.GetId(windowIdText)); }
        ...
        {
            Window(BlackFire.Utility.Unique.GetId(windowIdText), title,x,y,width,height,drawWindowCallbak, dragHeight,texture);
        }
