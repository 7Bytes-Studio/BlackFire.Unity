...
namespace BlackFire.Unity.Editor
{
    ...
    public class SerializedFieldRenderer : FieldRenderer
    {
        ...
        {
            Utils.CreateAssetFrom<SerializedFieldRenderer>(this, "SerializedField_" + _label, path);
        }
        ...
        public override void Render(Action preRender = null)
        {
            ...
            EditorGUILayout.PropertyField(serializedProperty, new GUIContent(_label), true, GUILayout.MinWidth(30f)); 
